...
public class FoodCartServiceImpl implements FoodCartService {
	...
	@Override
	public FoodCart addItemToCart(Integer customerId, Integer itemId)
...
//			throw new LoginException("Login required");
	...
	@Override
	public FoodCart removeItem(Integer cartId, Integer itemId) throws FoodCartException, ItemException, LoginException {
		// TODO Auto-generated method stub

//		CurrentUserSession currSess = currSession.findByPrivateKey(key);
//		if (currSess == null)
//			throw new LoginException("Login required");
		System.out.println("Item id and cartID is "+itemId+" "+cartId);
...
//
//	        List<Item> itemList = foodCart.getItemList();
//	        System.out.println("The food cartr item lst is "+itemList);
//
