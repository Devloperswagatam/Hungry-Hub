...
public class CustomerController {
	...
	@PutMapping("/update")
	public ResponseEntity<Customer> updateCustomer(@RequestHeader String key,
...
//		Customer returnCustomer = customerService.addCustomer(customer);
	...
	public ResponseEntity<Customer> deleteCustomerById(@RequestHeader String key,
	...
	@GetMapping("/all")
	public ResponseEntity<List<Customer>> viewAllCustomers(@RequestHeader String key)
